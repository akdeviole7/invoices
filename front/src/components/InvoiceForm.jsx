...
import { clientAPI, templateAPI } from '../services/api';
        ...
        {items.map((item, index) => (
          <div key={index} className="bg-gray-50 p-6 rounded-lg mb-4">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4 items-end">
              ...
              <button
                type="button"
                className="text-red-500 p-3 rounded-lg hover:bg-red-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed md:col-start-5"
